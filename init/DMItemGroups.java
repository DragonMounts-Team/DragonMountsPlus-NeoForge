...
public class DMItemGroups {
    ...
    public static void register(ItemCategory.Registry registry) {
        ...
        registry.register(ITEM_TAB, "itemGroup.dragonmounts.plus.items", () -> new ItemStack(DMItems.ENDER_DRAGON_SCALES.value()));
        registry.register(TOOL_TAB, "itemGroup.dragonmounts.plus.tools", () -> new ItemStack(DMItems.ENDER_DRAGON_SCALE_SWORD.value()));
    }
}
