...
import net.dragonmounts.plus.common.item.DragonAmuletItem;
...
public class SaveCommand {
    ...
    public static int saveSpawnEgg(CommandContext<CommandSourceStack> context, Entity target) throws CommandSyntaxException {
        ...
        if (type.canSerialize()) {
            ...
            if (item == null) {
                source.sendFailure(Component.translatable("commands.dragonmounts.plus.save.no_spawn_egg", target.getDisplayName()));
                return 0;
            }
